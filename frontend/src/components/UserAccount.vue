  ...
  <section class="bg-green-50 min-h-screen">
    <div class="container m-auto py-10 px-6">
      ...
      >
            ...
            <div class="space-y-4">
              ...
              <div>
                ...
                <div class="bg-gray-50 p-3 rounded border">
                  <div
                    v-if="userProfile.roles && userProfile.roles.length > 0"
        ...
        <div
          v-if="userProfile.adminRestaurants && userProfile.adminRestaurants.length > 0"
        ...
        <div class="bg-gradient-to-r from-green-500 to-green-600 text-white p-6 rounded-lg shadow-md mt-6">
          ...
          <div class="grid grid-cols-1 md:grid-cols-3 gap-4 text-center">
            ...
            <div class="bg-white bg-opacity-20 rounded-lg p-4">
              <div class="text-2xl font-bold">
                {{ userProfile.adminRestaurants?.length || 0 }}
              </div>
              <div class="text-sm opacity-90">
                Admin Restaurants
              </div>
