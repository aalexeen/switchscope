...
// Use the Installable Types composable
const {
  installableTypes,
  isLoading,
  error,
...
const displayedTypes = computed(() => {
  const types = props.filteredTypes !== null ? props.filteredTypes : installableTypes.value;
...
onMounted(async () => {
  try {
    ...
    console.error('Error loading installable types:', err);
  }
});
</script>
  ...
  <section class="bg-blue-50 px-4 py-10">
    <div class="container-xl lg:container m-auto">
      <h2 class="text-3xl font-bold text-indigo-500 mb-6 text-center">
        Browse Installable Types - Catalog
      </h2>
        ...
        <div class="overflow-x-auto">
          <table class="min-w-full divide-y divide-gray-200">
            ...
            <tbody class="bg-white divide-y divide-gray-200">
              <InstallableTypeListTable
                v-for="installableType in displayedTypes"
                :key="installableType.id"
                :installable-type="installableType"
                @view="(t) => $emit('view', t)"
                @edit="(t) => $emit('edit', t)"
