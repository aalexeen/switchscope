...
import LocationTypeListTable from './LocationTypeListTable.vue';
import { defineProps, onMounted, computed } from 'vue';
import { useLocationTypes } from '@/composables/useLocationTypes';
import PulseLoader from 'vue-spinner/src/PulseLoader.vue';

// Use the Location Types composable
const {
  locationTypes,
  isLoading,
  error,
...
const displayedTypes = computed(() => {
  const types = props.filteredTypes !== null ? props.filteredTypes : locationTypes.value;
          ...
          <table class="min-w-full divide-y divide-gray-200">
            ...
            <tbody class="bg-white divide-y divide-gray-200">
              <LocationTypeListTable
                v-for="locationType in displayedTypes"
                :key="locationType.id"
