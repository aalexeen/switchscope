...
включений важен: на чистой базе `fill/02` ещё вставляет старую колонку. Есть rollback, который
восстанавливает колонку из `role_id`.
...
**Чем проверено.** 131 тест зелёный. Живьём на `local`: отчёт реестра тот же (109 эндпоинтов, 101
