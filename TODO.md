...
явно. **141 тест зелёный** (было 127: четыре на то, что личность несёт права, шесть на
ёмкость стойки и четыре — снимок каталожного контракта, снятый до схлопывания контроллеров).
