...
springdoc и ошибочный диспатч целы после `denyAll()`. Чем отвечал несовпавший путь **до** правки —
не замерено: старый код не поднимается на мигрированной базе. Подробности —
`docs/backend-stage2-enforcement.md`, раздел «Этап 4».
